  ...
  return (
    <Box sx={{ p: 1 }}>
      ...
      <Paper elevation={0} sx={{ p: 2, border: "1px solid", borderColor: "divider", borderRadius: 2, mb: 3 }}>
        <Stack direction="row" spacing={2} flexWrap="wrap" alignItems="center" useFlexGap sx={{ rowGap: 2 }}>
          <TextField
          ...
          />
          <TextField select label="Status" name="status" value={filters.status} onChange={handleChange} size="small" sx={{ minWidth: 160 }}>
